...
function ButtonExample() {
    const handleClick = (e) => {
        e.stopPropagation(); // Stop the click event from bubbling up to the div or parent
    ...
    return (
        <>      
            <div className='wrapper' onClick={handleDivClick} style={{ padding: 20, backgroundColor: '#f0f0f0', marginTop: 20 }}>
                <button onClick={handleClick}>Click me!!!</button>
            </div>
        </>
    )
